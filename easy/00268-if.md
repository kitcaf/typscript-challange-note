...
### 解题关键
- **extends条件判断** `type IsString<T> = T extends string ? true : false`
- **extends类型约束**：将C约束只能是true 或者 false

### 核心步骤

- 第一步：extends限制C的类型
- 第二步：通过extends条件判断进行分支返回
...
- [原题链接](https://github.com/type-challenges/type-challenges/tree/main/questions/00268-easy-if)
